...
plot_predict_interaction(forest, test, "failures", "health")
plot_predict_interaction(forest, test, "failures", "absences")
plot_predict_interaction(forest, test, "failures", "age")
plot_predict_interaction(forest, test, "failures", "freetime")
plot_predict_interaction(forest, test, "failures", "famrel")
plot_predict_interaction(forest, test, "absences", "famrel")
plot_predict_interaction(forest, test, "absences", "freetime")
plot_predict_interaction(forest, test, "absences", "age")
